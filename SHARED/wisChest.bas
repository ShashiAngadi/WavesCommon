...
'Public Function FillView(view As ListView, rs As Recordset, Optional AutoWidth As Boolean) As Boolean
...
On Error Resume Next
    If IsNull(fld.Value) Then
        ...
        ' This will avoid potential run-time errors.
          ...
          If fld.Type = dbSingle Or fld.Type = dbLong Or fld.Type = dbDouble Or fld.Type = dbInteger Or fld.Type = dbCurrency Then
                FormatField = "0"
          End If
    Else
        ' Check if the field is date type.
