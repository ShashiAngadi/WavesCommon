...
Public lScript, lFontType As Long
...
Public SamhitaInitilized As Boolean
...
Public Function GetShreeNumber(ByVal InNumbr As Double, ByVal LSCR As Long) As String
  Dim BString As String * 200
  If lFontType = 0 Then
    Call SHREE_NUM_TO_WORDS(Pass1, Pass2, InNumbr, BString, LSCR, 0, 0)
  ElseIf lFontType = 15 Then 'Shree2000 Fontlayout
    Call SHREE2000_NUM_TO_WORDS(Pass1, Pass2, InNumbr, BString, LSCR, 0, 0)
  End If
  GetShreeNumber = adhTrimNull(BString)
End Function

Public Function GetSuchiNumber(ByVal InNumbr As Double, ByVal LSCR As Long) As String
  Dim BString As String * 200
  If lFontType = 1 Then
    Call SUCHI_NUM_TO_WORDS(Pass1, Pass2, InNumbr, BString, LSCR, 0, 0)
  ElseIf lFontType = 18 Then
    Call SUCHI2000_NUM_TO_WORDS(Pass1, Pass2, InNumbr, BString, LSCR, 0, 0)
  End If
  
  GetSuchiNumber = adhTrimNull(BString)
End Function

Public Function IsciiToSuchi(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(256)
  If lFontType = 1 Then
    BStr = ISCII_SUCHI(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 18 Then
    BStr = ISCII_SUCHI2000(Pass1, Pass2, AStr, BStr, LSCR)
  End If
  IsciiToSuchi = adhTrimNull(BStr)
End Function

Public Function SuchiToIscii(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(256)
  If lFontType = 1 Then
    BStr = SUCHI_ISCII(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 18 Then
    BStr = SUCHI2000_ISCII(Pass1, Pass2, AStr, BStr, LSCR)
  End If
  SuchiToIscii = adhTrimNull(BStr)
End Function

Public Function IsciiToShree(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(256)
  If lFontType = 0 Then
    BStr = ISCII_SHREE(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 15 Then
    BStr = ISCII_SHREE2000(Pass1, Pass2, AStr, BStr, LSCR)
  End If
  IsciiToShree = adhTrimNull(BStr)
End Function

Public Function ShreeToIscii(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(255)
  If lFontType = 0 Then
    BStr = SHREE_ISCII(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 15 Then
    BStr = SHREE2000_ISCII(Pass1, Pass2, AStr, BStr, LSCR)
  End If
  ShreeToIscii = adhTrimNull(BStr)
End Function

Public Function Sort32ToSuchi(ByRef AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(255)
  If lFontType = 1 Then
    BStr = SORT32_SUCHI(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 18 Then
    BStr = SORT32_SUCHI2000(Pass1, Pass2, AStr, BStr, LSCR)
  End If
  Sort32ToSuchi = adhTrimNull(BStr)
End Function

Public Function SuchiToSort32(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(255)
  If lFontType = 1 Then
    BStr = SUCHI_SORT32(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 18 Then
    BStr = SUCHI2000_SORT32(Pass1, Pass2, AStr, BStr, LSCR)
  End If
  SuchiToSort32 = adhTrimNull(BStr)
End Function

Public Function Sort32ToShree(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(255)
  If lFontType = 0 Then
    BStr = SORT32_SHREE(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 15 Then
    BStr = SORT32_SHREE2000(Pass1, Pass2, AStr, BStr, LSCR)
  End If
  Sort32ToShree = adhTrimNull(BStr)
End Function

Public Function ShreeToSort32(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(255)
  If lFontType = 0 Then
    BStr = SHREE_SORT32(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 15 Then
    BStr = SHREE2000_SORT32(Pass1, Pass2, AStr, BStr, LSCR)
  End If
  ShreeToSort32 = adhTrimNull(BStr)
End Function

Public Function PcIsciiToSuchi(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(256)
  If lFontType = 1 Then
    BStr = PCISCII_SUCHI(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 18 Then
    BStr = PCISCII_SUCHI2000(Pass1, Pass2, AStr, BStr, LSCR)
  End If
  PcIsciiToSuchi = adhTrimNull(BStr)
End Function
Public Function SuchiToPcIscii(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(256)
  If lFontType = 1 Then
    BStr = SUCHI_PCISCII(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 18 Then
    BStr = SUCHI2000_PCISCII(Pass1, Pass2, AStr, BStr, LSCR)
  End If
  SuchiToPcIscii = adhTrimNull(BStr)
End Function

Public Function PcIsciiToShree(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(256)
  If lFontType = 0 Then
    BStr = PCISCII_SHREE(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 15 Then
    BStr = PCISCII_SHREE2000(Pass1, Pass2, AStr, BStr, LSCR)
  End If
  PcIsciiToShree = adhTrimNull(BStr)
End Function

Public Function ShreeToPcIscii(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(256)
  If lFontType = 0 Then
    BStr = SHREE_PCISCII(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 15 Then
    BStr = SHREE2000_PCISCII(Pass1, Pass2, AStr, BStr, LSCR)
  End If
  ShreeToPcIscii = adhTrimNull(BStr)
End Function

Public Function EAIsciiToSuchi(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(256)
  If lFontType = 1 Then
    BStr = EAISCII_SUCHI(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 18 Then
    BStr = EAISCII_SUCHI2000(Pass1, Pass2, AStr, BStr, LSCR)
  End If
  EAIsciiToSuchi = adhTrimNull(BStr)
End Function

Public Function SuchiToEAIscii(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(256)
  If lFontType = 1 Then
...
Public Function EAIsciiToShree(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(256)
  If lFontType = 0 Then
    BStr = EAISCII_SHREE(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 15 Then
    BStr = EAISCII_SHREE2000(Pass1, Pass2, AStr, BStr, LSCR)
  End If
  EAIsciiToShree = adhTrimNull(BStr)
End Function
Public Function ShreeToEAIscii(ByVal AString As String, ByVal LSCR As Long) As String
  Dim AStr As String, BStr As String
  AStr = adhTrimNull(AString)
  BStr = Space$(256)
  If lFontType = 0 Then
    BStr = SHREE_EAISCII(Pass1, Pass2, AStr, BStr, LSCR)
  ElseIf lFontType = 15 Then
    BStr = SHREE2000_EAISCII(Pass1, Pass2, AStr, BStr, LSCR)
  End If
