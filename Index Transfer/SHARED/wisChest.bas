...
Public Function GetMonthString(ByVal MonVal As Byte) As String
    ...
    If gLangOffSet = wis_KannadaOffset Then
        Select Case MonVal
            Case 1
                GetMonthString = "¸ÂðÆð"  '"jan
            Case 2
                GetMonthString = "ÃúÄæÆð" 'Feb
            Case 3
                GetMonthString = "Æðõñ¶ðž" 'March
            Case 4
                GetMonthString = "¨ŒæÉý" 'April
            Case 5
                GetMonthString = "Æúôó" 'May
            Case 6
                GetMonthString = "¸÷Âð" ' June
            Case 7
                GetMonthString = "¸ôÈ" 'July
            Case 8
                GetMonthString = "¡³ðÍðÚ"  '"agust
            Case 9
                GetMonthString = "ÍðÃðÚ®ÄÇð" 'Sept
            Case 10
                GetMonthString = "¡°ú÷ÚóÄÇð" 'Oct
            Case 11
                GetMonthString = "ÂðÆð®ÄÇð" 'Nov
            Case 12
                GetMonthString = "ˆÍú®ÄÇð" 'dec
        End Select
    Else
        Select Case MonVal
            Case 1
...
Public Function SaveGridSettings(grd As Object, GrdName As String, FileName As String) As Boolean
Dim Ret As Integer
Dim i As Integer
...
With view
    ...
    Do While Not rs.EOF
         ...
         DoEvents
         ' Add the details.
        'Set itmX = .ListItems.Add( KeyCount, "KEY" & KeyCount, FormatField(rs.fields(0)))
