...
With grd
    ...
    For RowCount = 0 To .FixedRows - 1
        ...
        For ColCount = 0 To MaxCol
            .Col = ColCount
            XlApp.Application.Cells(5, ColCount + 1).Font.Name = gFont '.CellFontName
            XlApp.Application.Cells(5, ColCount + 1).Font.Bold = .CellFontBold
            XlApp.Application.Cells(5, ColCount + 1) = .Text
        Next
    Next RowCount
End With
...
Do
    If RowCount + intialRow >= MaxRow Then Exit Do
    'grd.Row = RowCount
